...
func service(provider *atlas.Provider, ch *credentials) (service brokerapi.Service) {
...
func groupID(planID string, creds *credentials) string {
...
func findInstanceSizeByPlanID(provider *atlas.Provider, ch *credentials, planID string) (*atlas.InstanceSize, error) {
...
func plansForProvider(provider *atlas.Provider, ch *credentials) []brokerapi.ServicePlan {
