...
// setup sets up a test HTTP server along with a mongodbrealm.Client that is
...
// If a nil body is passed to mongodbrealm.NewRequest, make sure that nil is also
